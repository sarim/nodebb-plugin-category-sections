					...
					<div class="well section">
						...
						<div class="section-sortable">
							...
							<div class="panel panel-body category-selector">
								<h5>{data.sections.categories.name} <br /><small>{data.sections.categories.description}</small></h5>
			...
			<div class="panel-body">
				<form role="form">
					<div class="section-sortable">
						...
						<div class="panel panel-body category-selector">
							<h5>{data.uncategorized.name} <br /><small>{data.uncategorized.description}</small></h5>
